...
function ClimateDashboard() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      {/* Sub bar for search and filters */}
      <div className="px-4 md:px-6 py-3.5 flex flex-col gap-3 border-b border-border/40 bg-background/20">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex-1 max-w-xl glass-strong rounded-xl px-3.5 py-2 flex items-center gap-2">
